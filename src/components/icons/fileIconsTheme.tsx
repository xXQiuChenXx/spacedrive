...
export const FileArchieveIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" {...props}>
    <path
      fill="var(--icon-color)"
...
export const fileIconsTheme = {
  image: (props: React.SVGProps<SVGSVGElement>) => <ImageIcon {...props} />,
  pdf: (props: React.SVGProps<SVGSVGElement>) => <PDFIcon {...props} />,
  word: (props: React.SVGProps<SVGSVGElement>) => <WordIcon {...props} />,
  powerpoint: (props: React.SVGProps<SVGSVGElement>) => (
    <PowerPointIcon {...props} />
  ),
  excel: (props: React.SVGProps<SVGSVGElement>) => <ExcelIcon {...props} />,
  audio: (props: React.SVGProps<SVGSVGElement>) => <FileMusic {...props} />,
  video: (props: React.SVGProps<SVGSVGElement>) => <FileVideo {...props} />,
  archive: (props: React.SVGProps<SVGSVGElement>) => (
    <FileArchieveIcon {...props} />
  ),
  code: (props: React.SVGProps<SVGSVGElement>) => <FileCode {...props} />,
  text: (props: React.SVGProps<SVGSVGElement>) => <FileTextIcon {...props} />,
  markdown: (props: React.SVGProps<SVGSVGElement>) => (
    <MarkdownIcon {...props} />
  ),
  book: (props: React.SVGProps<SVGSVGElement>) => <BookMarked {...props} />,
  link: (props: React.SVGProps<SVGSVGElement>) => <LinkIcon {...props} />,
  folder: (props: React.SVGProps<SVGSVGElement>) => <FolderIcon {...props} />,
  file: (props: React.SVGProps<SVGSVGElement>) => (
    <DefaultFileIcon {...props} />
  ),
};
